...

{
  ...
  # Enable Hyprland at the system level (installs the package, adds wayland session)
  programs.hyprland.enable = true;

  # Configure Hyprland for all home-manager users on this system
  home-manager.sharedModules = [
    {
      ...
      wayland.windowManager.hyprland.settings = {
        ...
        exec-once = [
          "hyprpanel"
          #"swaybg --image ~/.local/share/wallpapers/wallpaper.jpeg --mode fill"
