...

{
  ...
  networking.hostName = "core-vm-news-01"; # Define your hostname.
  ...
  # Required overlay for CPU-only Ollama (for News Digest AI)
  nixpkgs.overlays = [
    (self: super: {
      ollama-cpu = super.ollama.override { enableCUDA = false; };
    })
  ];

  # News Digest service configuration
  services.news = {
    enable = true;
    schedule = "06:30";
