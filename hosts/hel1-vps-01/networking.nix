...

{
    networking = {
        ...
        defaultGateway = {
            address = "172.31.1.1";
            onlink = true; # Required since the gateway is not in the same subnet as the VPS's IP
        };
        ...
        nameservers = [ "185.12.64.2" "185.12.64.1" "2a01:4ff:ff00::add:2" "2a01:4ff:ff00::add:1" ];
